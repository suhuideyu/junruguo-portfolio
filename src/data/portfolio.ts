  ...
  experiences: [
    {
      ...
      "role": "项目助理兼职（软件方向）",
      "period": "2025.11 — 至今",
      "summary": "支持ToB/C 端软件项目实施与交付，串联设备配置、平台核查、异常分析、问题跟踪与资料沉淀。",
      "highlights": [
    ...
    },
    {
      ...
      "summary": "建立 30+ 家竞品参数对标表，整理 11 套方案 PPT / SOP，并通过台账跟进 15+ 订单节点与异常事项。",
      "highlights": [
        "竞品梳理：整理30余家厂商产品参数，完成竞品对标表格，为方案选型提供参考依据。",
        "文档输出：协助输出11套业务方案PPT与标准化SOP文档，沉淀业务交付资料。",
        "订单跟进：使用台账跟踪10余条订单进度，记录节点信息，同步跟进业务异常事项。"
      ],
    },
    {
      ...
      "highlights": [
        ...
        "环境适配：适应车间轮班作业模式，理解制造企业现场工作节奏，积累技术支持岗位所需的现场抗压经验。"
      ]    
    },
  ],
  featuredProjects: [
